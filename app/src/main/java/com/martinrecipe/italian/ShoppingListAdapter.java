...
public class ShoppingListAdapter extends ArrayAdapter<IngredientItem> implements UndoAdapter {
    ...
    public View getUndoView(final int position, final View convertView, @NonNull final ViewGroup parent) {
        ...
        if (view == null) {
            view = LayoutInflater.from(mContext).inflate(com.martinrecipe.neurondigital_listview.R.layout.list_row_singleline_undo, parent, false);
        }
        return view;
    }
    ...
    public View getUndoClickView(@NonNull final View view) {
        return view.findViewById(com.martinrecipe.neurondigital_listview.R.id.undo_row_undobutton);
    }
